...
export default function Sidebar() {
  ...
  return (
    <aside
      className={clsx(
        'flex flex-col bg-white border-r border-gray-200 transition-all duration-300 shadow-sm relative',
        collapsed ? 'w-16' : 'w-56'
      )}
    >
      {/* Logo */}
...
function SidebarClock() {
  // null on server to avoid hydration mismatch — set on client mount only
